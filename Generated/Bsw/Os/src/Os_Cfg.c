...
uint64 Os_csa_taskinit_buf[OS_CSA_TASKINIT_CALLDEEPTH];
uint64 Os_csa_tasktiming10ms_buf[OS_CSA_TASKTIMING10MS_CALLDEEPTH];
uint64 Os_csa_taskevent20ms_buf[OS_CSA_TASKEVENT20MS_CALLDEEPTH];